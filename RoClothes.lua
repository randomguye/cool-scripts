...
function RoClothes(Player)
	...
	function Function.PartListDefault()
		return {
			...
			["Kitty Bra Top Whiskers"] = {
				...
				["Transparency"] = 0,
				["Material"] = Enum.Material.Plastic,
				["MeshId"] = "rbxasset://6764807950.png",
				["DoubleSided"] = false,
				["TextureId"] = "",
				["Color"] = {
					["Tone"] = "Base",
	...
	function Function.TorsoShirtTexture(ObjectInstance, Character, Extra, Data)
		if Extra.Shirt and (table.find(PlayerData[Data].CurrentClothes, "Roblox Clothes") or table.find(PlayerData[Data].CurrentClothes, "Roblox Clothes Without Breasts") or table.find(PlayerData[Data].CurrentClothes, "New Woman")) then
			local SP = Instance.new("SurfaceAppearance", ObjectInstance)
			SP.ColorMap = Extra.Shirt.ShirtTemplate
